...
class RegistrationCreateCabinetPageLocators(BasePageLocators):
    ...
    def INN_ERROR(inn_label):
        return By.XPATH, f"//*[@role='alert' and preceding-sibling::*[text()='{inn_label}']]"
    ...
    def MAILING_CHECKBOX(checkbox_label): 
        return By.XPATH, f"//*[contains(@class, 'vkuiCheckbox__icon') and following-sibling::*[descendant::*[contains(., '{checkbox_label}')]]]"

    @staticmethod
    def MAILING_CHECKBOX_HINT(checkbox_label): 
        return By.XPATH, f"//*[contains(@class, 'Hint_hintTrigger') and preceding-sibling::*[contains(., '{checkbox_label}')]]"
