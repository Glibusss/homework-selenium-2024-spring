...
class SettingsCommonPageLocators(BasePageLocators):
    ...
    PHONE_NUMBER_ERROR = (
        By.XPATH,
        "//*[contains(@class, 'Contacts_wrap__')]//*[@role='alert']/div",
    )
    ...
    EMAIL_ERROR = (
        By.XPATH,
        "//*[contains(@class, 'vkuiFormItem__removable')]//*[@role='alert']/div",
    )
    ...
    LOGOUT_OTHER_DEVICES_SUCCESS_MESSAGE = (
        By.XPATH,
        "//*[contains(@class, 'Snackbar_success__')]",
    )

    DELETE_CABINET_BUTTON = (
        By.XPATH,
        "//*[contains(@class, 'vkuiButton__content') and text()='Удалить кабинет']",
    )
    DELETE_CABINET_MODAL_PAGE = (
        By.XPATH,
