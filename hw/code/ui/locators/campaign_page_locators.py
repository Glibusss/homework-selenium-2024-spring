...
class CampaignPageLocators(BasePageLocators):
    ...
    CREATE_FOOTER_PUBLISH = (By.XPATH, "//*[contains(@class, 'CreateFooter_footer__')]//*[contains(@class, 'vkuiButton__content') and text() = 'Опубликовать']")
    ...
    #Такие сложные селекторы, потому что кроме названия не к чему привязаться
    ...
    SHORT_DESCRIPTION = (By.XPATH, "//*[contains(@class, 'vkuiFormItem') and .//*[text()='Короткое описание']]//textarea")
    LONG_DESCRIPTION = (By.XPATH, "//*[contains(@class, 'vkuiFormItem') and .//*[text()='Длинное описание']]//textarea")
    BUTTON_TEXT_INPUT = (By.XPATH, "//*[contains(@class, 'vkuiFormItem') and .//*[text()='Текст рядом с кнопкой']]//input")
    ADVERTISER_DESCRIPTION = (By.XPATH, "//*[contains(@class, 'vkuiFormItem') and .//*[text()='Данные рекламодателя']]//textarea")
    ...
    def ENTITY_NAME_CELL(name):
        return (By.XPATH, f"//*[contains(@class, 'nameCellContent_text__') and text()='{name}']")
    ...
    # Чтобы контроллировать состояние чекбокса
    @staticmethod
    ...
    MODAL_SEND_BUTTON = (By.XPATH, "//*[contains(@class, 'vkuiModalCard')]//*[contains(@class, 'vkuiButton__content') and text()='Отправить']")
    MODAL_CANCEL_BUTTON = (By.XPATH, "//*[contains(@class, 'vkuiModalCard')]//*[contains(@class, 'vkuiButton__content') and text()='Отмена']")

    #Тут больше не за что зацепиться в селекторе
    @staticmethod
    ...
    def STOP_INTEREST_CHIP(interest):
        return (By.XPATH, f"//*[contains(@class, 'vkuiFormItem') and .//*[contains(@class, 'vkuiTypography') and text()='Исключая интересы']]//*[text()='{interest}']")
    
    #Если не так, то валятся тесты на инпуте
    @staticmethod
    def SIDEBAR_AD_INPUT(input, value):
        return (By.XPATH, f"//*[contains(@class, 'vkuiFormItem') and .//*[text()='{input}']]//input[@value='{value}']")
