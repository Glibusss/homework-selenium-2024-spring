...
class RegistrationImportMytargetPageLocators(BasePageLocators):
    ...
    ACCOUNT_TYPE_SWITCH = (
        By.XPATH,
        "//*[contains(@class, 'ImportPanel_panelSubTitle')]/descendant::*[contains(@class, 'vkuiSegmentedControl__in')]",
    )
    ...
    def ACCOUNT_TYPE_SELECTOR_BY_TEXT(account_type):
        return (
            By.XPATH,
            f"//*[contains(@class, 'vkuiSegmentedControlOption')]/*[following-sibling::*[text()='{account_type}']]",
        )
    ...
    def ACCOUNT_TYPE_SELECTOR_BY_VALUE(value):
        return (
            By.XPATH,
            f"//*[contains(@class, 'vkuiSegmentedControlOption')]/*[@value='{value}']",
        )

    SWITCH_SELECTED_ACCOUNT_TYPE = (
        By.XPATH,
        "//*[contains(@class, 'ImportPanel_panelSubTitle')]/descendant::*[contains(@class, 'vkuiSegmentedControlOption--checked')]/descendant::input",
    )

    SWITCH_SELECTED_ACCOUNT_LABEL = (
        By.XPATH,
        "//*[contains(@class, 'ImportPanel_panelSubTitle')]/descendant::*[contains(@class, 'vkuiSegmentedControlOption--checked')]/descendant::h4",
    )
    ...
    IMPORT_BENEFIT_ICON = (
        By.XPATH,
        "//*[contains(@class, 'ImportPanel_grantCell')]/descendant::*[contains(@class, 'vkuiIcon')]",
    )

    IMPORT_BENEFIT_ITEM_TITLE = (
        By.XPATH,
        "//*[contains(@class, 'ImportPanel_grantCellTitle')]",
    )

    IMPORT_BENEFIT_ITEM_DESC = (
        By.XPATH,
        "//*[contains(@class, 'ImportPanel_grantCellDesc')]",
    )
