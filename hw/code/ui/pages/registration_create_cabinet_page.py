...
from ui.locators.registration_create_cabinet_page_locators import (
    RegistrationCreateCabinetPageLocators,
)
...
class RegistrationCreateCabinetPage(BasePage):
    ...
    def language_text_became_visible(self, language: str) -> bool:
        return (
            ...
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["CREATE_PAGE_TITLE"])
            )
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["ACCOUNT_TYPE"])
            )
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["ADVERTISER_NOMINATIVE"])
            )
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["AGENCY_NOMINATIVE"])
            )
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["CHOOSE_COUNTRY"])
            )
            & self.country_list_contains_russia_and_other(language)
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["CURRENCY"])
            )
            ...
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["FULL_NAME"])
            )
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["ACCEPT_CHECKBOX"])
            )
            ...
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["PRIVACY"])
            )
            & self.became_visible(
                self.locators.TEXT(self.page_text[language]["MAILING"])
            )
    ...
    def account_type_label_became_visible(self, language: str):
        return (
            len(
                self.find_all(
                    self.locators.ACCOUNT_TYPE_LABEL(
                        self.page_text[language]["ACCOUNT_TYPE"]
                    )
                )
            )
            == 2
    ...
    def select_individual_account(self, language: str):
        self.scroll_and_click(
            self.locators.ACCOUNT_TYPE_BUTTON(self.page_text[language]["INDIVIDUAL"])
        )

    def select_legal_entity_account(self, language: str):
        self.scroll_and_click(
            self.locators.ACCOUNT_TYPE_BUTTON(self.page_text[language]["LEGAL_ENTITY"])
        )

    def select_advertiser_account(self, language: str):
        self.scroll_and_click(
            self.locators.ACCOUNT_TYPE_BUTTON(
                self.page_text[language]["ADVERTISER_NOMINATIVE"]
            )
        )
    ...
    def select_agency_account(self, language: str):
        self.scroll_and_click(
            self.locators.ACCOUNT_TYPE_BUTTON(
                self.page_text[language]["AGENCY_NOMINATIVE"]
            )
        )
    ...
    def check_individual_hint_content(self, language: str):
        ...
        check = self.became_visible(
            self.locators.TEXT(self.page_text[language]["INDIVIDUAL_HINT"])
        )
        self.hover_image()
        return check
    ...
    def check_legal_entity_hint_content(self, language: str):
        ...
        check = self.became_visible(
            self.locators.TEXT(self.page_text[language]["LEGAL_ENTITY_HINT"])
        )
        self.hover_image()
        return check
    ...
    def country_list_contains_russia_and_other(self, language: str) -> bool:
        ...
        check = self.became_visible(
            self.locators.TEXT(self.page_text[language]["RUSSIA"])
    ...
    def check_row_individual_warning(self, language: str):
        self.select_country(self.page_text[language]["ARMENIA"])
        check = self.became_visible(
            self.locators.TEXT(self.page_text[language]["ROW_INDIVIDUAL_WARNING"])
        )
        self.select_country(self.page_text[language]["RUSSIA"])
        return check
    ...
    def check_russia_currency_options(self, language: str):
        ...
        check = self.became_visible(
            self.locators.TEXT(self.page_text[language]["RUBLE"])
        )
        self.click_image()
        return check
    ...
    def check_row_currency_options(self, language: str):
        ...
        self.click_currency_selector()
        check = self.became_visible(
            self.locators.TEXT(self.page_text[language]["DOLLAR"])
    ...
    def get_inn_error(self, language: str, timeout: int = None) -> str:
        return self.find(
            self.locators.INN_ERROR(self.page_text[language]["INN"]), timeout
        ).text
    ...
    def checkbox_checked(self, label: str):
        return self.became_visible(
            self.locators.CHECKBOX_IS_CHECKED_OR_NOT(label, "on")
        )

    def checkbox_unchecked(self, label: str):
        return self.became_visible(
            self.locators.CHECKBOX_IS_CHECKED_OR_NOT(label, "off")
        )
    ...
    def mailing_checkbox_became_visible(self, language: str):
        return self.became_visible(
            self.locators.MAILING_CHECKBOX(self.page_text[language]["MAILING"])
        )
    ...
    def mailing_hint_became_visible(self, language: str):
        return self.became_visible(
            self.locators.MAILING_CHECKBOX_HINT(self.page_text[language]["MAILING"])
        )
    ...
    def check_mailing_hint_content(self, language: str):
        ...
        check = self.became_visible(
            self.locators.TEXT(self.page_text[language]["MAILING_HINT"])
        )
        self.hover_image()
        return check
