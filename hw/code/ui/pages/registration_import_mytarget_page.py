...
class RegistrationImportMytargetPage(BasePage):
    ...
    def language_text_became_visible(self, language: str) -> bool:   
        ...
        return (
            ...
            self.became_visible(self.locators.TEXT(self.page_text[language]['IMPORT_PAGE_TITLE'])) &
            self.became_visible(self.locators.TEXT(self.page_text[language]['IMPORT_PAGE_SUBTITLE'])) &
            self.became_visible(self.locators.TEXT(self.page_text[language]['ADVERTISER_DATIVE'])) &
            self.became_visible(self.locators.TEXT(self.page_text[language]['AGENCY_DATIVE'])) &
            benefit_check &
            self.became_visible(self.locators.TEXT(self.page_text[language]['CONTINUE'])) &
            self.became_visible(self.locators.TEXT(self.page_text[language]['CONTINUE_DESC']))
        )
    ...
    def check_benefit_contents(self, language: str, account_type: str) -> bool:
        ...
        for i, benefit in enumerate(benefits):
            ...
            benefit_check &= benefit[1] == self.page_text[language][account_type][i]['title']
            benefit_check &= benefit[2] == self.page_text[language][account_type][i]['desc']
