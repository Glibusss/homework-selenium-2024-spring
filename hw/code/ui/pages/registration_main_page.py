...
class RegistrationMainPage(BasePage):
    ...
    def language_text_became_visible(self, language: str):
        return (
            self.became_visible(self.locators.TEXT(self.page_text[language]['MAIN_PAGE_TITLE'])) &
            self.became_visible(self.locators.TEXT(self.page_text[language]['MAIN_PAGE_SUBTITLE'])) &
            self.became_visible(self.locators.TEXT(self.page_text[language]['CREATE_CABINET'])) &
            self.became_visible(self.locators.TEXT(self.page_text[language]['IMPORT_MYTARGET'])) &
