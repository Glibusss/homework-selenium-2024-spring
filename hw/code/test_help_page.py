...
class TestHelpPage(BaseCase):
    ...
    def test_help_tooltip_opened(self, help_page):
        help_page.click_help_cell()
        assert help_page.tooltip_became_visible()

    def test_help_tooltip_closed(self, help_page):
        help_page.click_help_cell()
        help_page.click_help_cell()
        assert help_page.tooltip_became_invisible()

    def test_cells_became_visible(self, help_page):
        help_page.click_help_cell()
        assert help_page.cells_became_visible()

    def test_iframe_became_visible(self, help_page):
        help_page.click_help_cell()
