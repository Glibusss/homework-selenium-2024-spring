...
class TestSettingsNotificationsPage(BaseCase):
    ...
    def test_save_modal_became_visible_switch_click(self, settings_notifications_page):
        settings_notifications_page.click_switch()
        assert settings_notifications_page.save_modal_became_visible()

    def test_save_modal_became_visible_checkbox_click(self, settings_notifications_page):
        settings_notifications_page.click_checkbox()
        assert settings_notifications_page.save_modal_became_visible()

    def test_on_checkbox_click_checkbox_changed(self, settings_notifications_page):
    ...
    def test_on_cancel_click_checkbox_returned(self, settings_notifications_page):
        checked = settings_notifications_page.checkbox_checked()
        settings_notifications_page.click_checkbox()
    ...
    def test_on_save_click_checkbox_saved(self, settings_notifications_page):
        checked = settings_notifications_page.checkbox_checked()
        print(checked)
        settings_notifications_page.click_checkbox()
