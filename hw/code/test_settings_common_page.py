...
class TestSettingsCommonPage(BaseCase):
    ...
    def test_is_error_invalid_phone_number(self, settings_common_page):
        ...
        assert (
            settings_common_page.get_phone_number_error()
            == settings_common_page.ERROR_INVALID_PHONE_NUMBER
        )
    ...
    def test_is_additional_email_inputs_became_visible(self, settings_common_page):
        ...
        assert settings_common_page.additional_email_input_became_visible(
            email_fields_counter
        )
    ...
    def test_is_error_invalid_email(self, settings_common_page):
        ...
        assert (
            settings_common_page.get_email_error()
            == settings_common_page.ERROR_INVALID_EMAIL
        )
    ...
    def test_is_error_empty_fields(self, settings_common_page):
        ...
        assert (
            settings_common_page.get_email_error()
            == settings_common_page.ERROR_EMPTY_FIELD
        )
        assert (
            settings_common_page.get_full_name_error()
            == settings_common_page.ERROR_EMPTY_FIELD
        )
        assert (
            settings_common_page.get_inn_error()
            == settings_common_page.ERROR_EMPTY_FIELD
        )
    ...
    def test_is_error_too_short_inn(self, settings_common_page):
        ...
        assert (
            settings_common_page.get_inn_error()
            == settings_common_page.ERROR_TOO_SHORT_INN
        )
    ...
    def test_is_error_invalid_inn(self, settings_common_page):
        ...
        assert (
            settings_common_page.get_inn_error()
            == settings_common_page.ERROR_INVALID_INN
        )
