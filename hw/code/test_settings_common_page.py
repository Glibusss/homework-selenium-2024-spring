...
class TestSettingsCommonPage(BaseCase):
    ...
    def test_save_and_cancel_buttons_became_visible(self, settings_common_page):
        settings_common_page.enter_full_name(self.FULL_NAME)
        assert settings_common_page.save_and_cancel_buttons_became_visible()

    def test_error_invalid_phone_number(self, settings_common_page):
    ...
    def test_additional_email_inputs_became_visible(self, settings_common_page):
    ...
    def test_error_invalid_email(self, settings_common_page):
        settings_common_page.click_add_email_button()
    ...
    def test_error_empty_fields(self, settings_common_page):
        settings_common_page.click_add_email_button()
    ...
    def test_delete_cabinet_modal_page_became_visible(self, settings_common_page):
