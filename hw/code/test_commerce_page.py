...
class TestCommercePage(BaseCase):
    ...
    def test_commerce_page_opened(self, commerce_page):
    ...
    def test_feed_or_community_became_visible(self, commerce_page):
        commerce_page.click_create_button()
        commerce_page.click_feed_tabs()
        assert commerce_page.feed_or_community_became_visible()

    def test_feed_errors_become_visible(self, commerce_page):
        commerce_page.click_create_button()
        commerce_page.click_feed_tabs()
    ...
    def test_marketplace_became_visible(self, commerce_page):
        commerce_page.click_create_button()
        commerce_page.click_marketplace_tabs()
        assert commerce_page.marketplace_became_visible()
        
    def test_marketplace_errors_become_visible(self, commerce_page):
        commerce_page.click_create_button()
        commerce_page.click_marketplace_tabs()
        for i in range(0,3):
    ...
    def test_manual_tabs_became_visible(self, commerce_page):
        commerce_page.click_create_button()
